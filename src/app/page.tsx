...
export default function Home() {
  ...
  return (
    <>
      {/* ─── NAVBAR ─── */}
      <nav className="sticky top-0 z-50 bg-card-light/95 dark:bg-background-dark/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 shadow-sm">
              ...
              <div className="flex flex-col space-y-3 pt-4">
                {[
                  ...
                  <a
                    ...
                    className="px-4 py-2 font-medium text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors"
                  >
                    {item.label}
                  </a>
                ))}
